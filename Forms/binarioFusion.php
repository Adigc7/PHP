...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"><h1>CONVERSOR BINARIO</h1>Numero decimal <input type='text' name='operando1' value='' size=15><br><br><input type="submit" value="enviar">
