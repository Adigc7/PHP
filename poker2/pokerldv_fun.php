...
function validarJugadores($nombre1,$nombre2,$nombre3,$nombre4,$nombre5,$nombre6,$nombre7,$nombre8,$jugadores,$baraja){
...
function jugadoresContador($jugadores){
	...
	{
		return "El número de jugadores es correcto". $ok=true . "<br>";
	}
...
function sacarMano($baraja){
		...
		for($i=0;$i<4;$i++){
            ...
            echo "<img src='images/$baraja[$posicion].PNG' width='60px'>";      
...
function jugar($jugadores,$baraja){
    if($ok=true){
        for($i=0;$i<count($jugadores);$i++){
            echo "El jugador " .$i. " tiene la mano:" . "<br>";
